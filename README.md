...
Способ № 1<br/>
&ensp;&ensp; В конце строки, начинающейся с linux 16 необходимо добавить параметрs rd.break (переход в командную<br/> строку в конце обработки initramfs)и enforcing=0
