...
exit
```
&ensp;&ensp;Чтобы осуществлять вход в систему, необходимо восстановить контекст безопасности системы SELinux<br/>.
Для этого необходимо при загрузке системы снова перевести систему
