...
&ensp;&ensp;Стоит отметить что, способ с добавлением в параметры загрузки только init=/bin/sh характерен для debian-like <br/>
дистрибутивов, и, возможно, других дистрибутивов. Использование данного способа для запуска CentOS вызывало сбой в<br/>
работе ядра (kernel panic). 
